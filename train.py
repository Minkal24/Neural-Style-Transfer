...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=r'C:\Users\hp\Desktop\project-NST\content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=r'C:\Users\hp\Desktop\project-NST\style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=r'C:\Users\hp\Desktop\project-NST\vgg_normalised.pth',
    ...
    parser.add_argument('--crop',action='store_true', default=True, help="size of final image")
     
    parser.add_argument('--batch_size',type=int, default=4)

    parser.add_argument("--lr",type=float,default=1e-4,help="learning rate")

    parser.add_argument("--lr_delay",type=float,default=5e-5,help="learning rate delay")

    parser.add_argument("--epochs", type=int,default=1,help="Numbers of epochs")
    ...
    parser.add_argument('--save_interval',type=int,default=2,help="Save_interval")
...
def main():
  ...
  scheduler = optim.lr_scheduler.LambdaLR(
     optimizer,
     lr_lambda=lambda epoch: 1.0/(1.0 +args.lr_delay *epoch)
  )
  ...
  for epoch in range(args.epochs):
      ...
      for content_batch, style_batch in progress_bar:
        ...
        progress_bar.set_description(f"Loss: {loss.item():4f},Content_Loss: {loss_c.item():4f}, Style_ Loss: {loss_s.item():4f}  ")
      ...
      if (epoch+1) % args.log_interval == 0:
         tqdm.write(f"Iter {epoch+1}: Loss: {running_loss:4f}, Content_Loss: {running_closs:4f}, Style_ Loss: {running_sloss:4f} ")
